                ...
                <?php foreach ($groups as $group): ?>
                    <div class="card">
                        <div class="card__content">
                            <a class="button button--primary" href="/groupe/<?= htmlspecialchars($group['id']) ?>">
                                    <?= htmlspecialchars($group['name']) ?>
                                </a>
                            <?php if ($group['owner_id'] == $_SESSION['user']['id']): ?>
                                <a class="button button--primary" href="/groupe/<?= htmlspecialchars($group['id']) ?>/members" class="manage-members-link">
                                        Gérer les membres
                                    </a>
                            <?php endif; ?>
                        </div>
